...
# MINIMUM SEASONS FOR PROGRAMS (was 5, now 25)
...
def process_state_data(cursor, state, mode):
    ...
    if mode == 'teams':
        ...
        # UPDATED: MinSeasons now uses configured value (25)
    ...
    for rank_row in rankings:
        ...
        # Build item - columns come directly from stored procedure
        item = {
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("State Teams & Programs JSON Generator")
    print(f"Min Seasons for Programs: {MIN_SEASONS_PROGRAMS}")
    print("=" * 60)
